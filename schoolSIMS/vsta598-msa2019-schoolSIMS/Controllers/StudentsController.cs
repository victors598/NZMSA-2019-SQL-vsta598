...
namespace vsta598_msa2019_schoolSIMS.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class StudentsController : ControllerBase
    {
        private readonly vsta598_msa2019_schoolsims _context;

        public StudentsController(vsta598_msa2019_schoolsims context)
        {
            _context = context;
        }
